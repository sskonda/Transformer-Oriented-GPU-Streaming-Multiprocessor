...
| Scheduler | Legal policy and pointer, selected warp ready, in range, and not barrier-blocked; no issue during reset |
| Tensor core | Legal dimensions and accumulator width, accepted-input latency, valid stability under backpressure, known control |
